...
--
-- Host: localhost    Database: irve_web
-- ------------------------------------------------------
...
--
-- Table structure for table `amenageur`
--
...
--
-- Dumping data for table `amenageur`
--

LOCK TABLES `amenageur` WRITE;
/*!40000 ALTER TABLE `amenageur` DISABLE KEYS */;
/*!40000 ALTER TABLE `amenageur` ENABLE KEYS */;
UNLOCK TABLES;
